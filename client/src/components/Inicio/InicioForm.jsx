  ...
  return (
    <div>
      <h1 className="text-xl mt-8 mb-12">
        En RoundPeople, tendrás acceso a una amplia selección de videos y música
        de artistas, además de la oportunidad de colaborar a través de nuestra
        plataforma
      </h1>
      ...
      <div className="items-center">
        ...
        <div className="flex justify-center items-center bg-[#450BB8] text-white p-4 mt-4 rounded-md mb-8">
          <div className="text-center">
            <p className="mb-2">
              Ahora puedes ser parte de la creación apoyando proyecto o artistas
              a través de nuestra función de crowdfounding.
            </p>
